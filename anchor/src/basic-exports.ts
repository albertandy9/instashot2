...
import BasicIDL from '../target/idl/base.json'
import type { Base } from '../target/types/base'

// Re-export the generated IDL and type
export { Base as Basic, BasicIDL }

// The programId is imported from the program IDL.
export const BASIC_PROGRAM_ID = new PublicKey(BasicIDL.address)

// This is a helper function to get the Basic Anchor program.
export function getBasicProgram(provider: AnchorProvider, address?: PublicKey): Program<Base> {
  return new Program({ ...BasicIDL, address: address ? address.toBase58() : BasicIDL.address } as Base, provider)
}
